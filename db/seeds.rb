...
play3 = BarBand.create(dive_bar_id: rocket_bar.id, band_id: ruby.id)
...
rev11 = Review.create(user_id: rob.id, dive_bar_id: jackpot.id, rating: 9, review: "A hidden gem!  So happy I found this place! It's small and cozy.  Not too loud either!
good place to take a date and get to know someone!  I just have to find a date first....")
rev12 = Review.create(user_id: sam.id, dive_bar_id: bottom.id, rating: 6, review: "Band was cool.  Vibe was just ok.  The Bottom Line is a solid spot in Foggy Bottom.  Happy Hour has some good deals.  Good deals and good beer 
are awlays good for me.  The bottom line is that the Bottom Line is a spot.")
rev13 = Review.create(user_id: luke.id, dive_bar_id: fox_hounds.id, rating: 2, review: "I would usually say that any place with alcohol is fine, but no.  I was not satisfied with their drinks!  The mixed
